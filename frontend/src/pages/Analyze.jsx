  ...
  return (
    <div className="container mx-auto my-12 px-4 md:px-6 lg:px-8">
      <article className="prose">
        ...
        <hr className="my-6 border-gray-300" />
        <h2 className="text-4xl font-bold tracking-tight text-black mt-10">Sentiment Analysis</h2>
...
// const AnalyzeComponent = ({ articleData, answerData, handleQuestionSubmit, setQuestion, question, questionsans }) => {
//   return (
//     <div className="container mx-auto my-12 px-4 md:px-6 lg:px-8">
//       <article className="prose">
...
//       const { answer, explanation } = { answer: "jskldfjaslkdf", explanation: "sfjfsdlajdflk" };
